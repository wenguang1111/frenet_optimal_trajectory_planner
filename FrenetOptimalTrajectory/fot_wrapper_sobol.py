import numpy as np
import FrenetOptimalTrajectory.py_cpp_struct as pcs
import os
...
try:
    from FrenetOptimalTrajectory.py_cpp_struct import FrenetInitialConditions, FrenetHyperparameters, \
        FrenetReturnValues
except:
...
def run_fot(initial_conditions, hyperparameters):
    ...
    # print(len(initial_conditions.wx))
    # run the planner
    _run_fot(initial_conditions, hyperparameters, fot_rv)
    if RECORD_DATA:
