...
public:
    ...
    QuarticPolynomial(fixp_s xs, fixp_s_d vxs, fixp_s_dd axs, fixp_s_d vxe,
                      fixp_s_dd axe, fixp_t t);
    fixp_s calc_point(fixp_t t);
    fixp_s_d calc_first_derivative(fixp_t t);
    fixp_s_dd calc_second_derivative(fixp_t t);
    fixp_s_ddd calc_third_derivative(fixp_t t);
private:
