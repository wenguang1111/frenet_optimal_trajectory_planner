...
public:
    ...
    QuinticPolynomial(fixp_c_d xs, fixp_c_d vxs, fixp_c_d axs, fixp_c_d xe,
                      fixp_c_d vxe, fixp_c_d axe, fixp_t t);
    fixp_d calc_point(fixp_t t);
    fixp_d_d calc_first_derivative(fixp_t t);
    fixp_d_dd calc_second_derivative(fixp_t t);
    fixp_d_ddd calc_third_derivative(fixp_t t);
private:
